...
Remote and read-only. Observes state of explicitly allow-listed units.
...
collect, lives in [docs/collectors/linux-services.md](../../../../docs/collectors/linux-services.md).
